...
return (
<aside className="hidden md:flex flex-col w-64 fixed h-full bg-white border-r
border-slate-200 z-40 py-6 px-4 shadow-[4px_0_24px_rgb(0,0,0,0.02)]">
...
key={item.name}
href={item.href}
className={`flex items-center space-x-3 px-4 py-3 rounded-xl text-sm
...
className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-slate-500
