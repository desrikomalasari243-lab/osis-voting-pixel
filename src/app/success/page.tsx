...
<div className="absolute top-0 left-0 w-125 h-125 bg-blue-100/40 rounded-full
blur-3xl -translate-x-1/4 -translate-y-1/4 pointer-events-none"></div>
<div className="absolute bottom-0 right-0 w-150 h-150 bg-blue-50/60 rounded-full
blur-3xl translate-x-1/4 translate-y-1/4 pointer-events-none"></div>
{/* Glassmorphism Card */}
<div className="w-full max-w-sm bg-white/80 backdrop-blur-lg border
border-white/40 shadow-xl shadow-blue-500/10 rounded-3xl p-8 text-center relative z-10
animate-in fade-in zoom-in duration-500">
{/* Ikon Sukses dengan Animasi */}
<div className="mx-auto w-24 h-24 bg-blue-50 text-blue-600 rounded-full flex
...
<div className="bg-slate-50 border border-slate-100 rounded-xl p-3 flex
...
<button
onClick={handleExit}
className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-medium
rounded-xl active:scale-[0.98] transition-all duration-200 shadow-md
shadow-blue-500/20"
>
