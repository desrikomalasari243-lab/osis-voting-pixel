...
import {
  ...
  DialogTitle,
  DialogFooter,
  // PERBAIKAN: Menghapus import DialogTrigger
    ...
    <main className="pt-20 md:pt-8 px-4 md:px-8 pb-24 md:pb-8 w-full grow">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          {/* PERBAIKAN: Menghapus DialogTrigger asChild, langsung pakai button biasa dengan onClick */}
          <button
          ...
          {/* PERBAIKAN: Mengubah sm:max-w-106.25 menjadi sm:max-w-[425px] agar valid */}
